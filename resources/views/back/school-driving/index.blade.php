...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class="flex flex-col w-full" method="GET" id="form-search" action="{{route('school-driving.index')}}" autocomplete="off">
                <div class="card-body">
                    <table class="table table-bordered table-view">
                        <tbody>
                            <tr>
                                <th class="w-20">教習所CD</th>
                                <td><input name="school_cd" value="{{old('school_cd', request()->query('school_cd'))}}" type="text" class="form-control" placeholder="" maxlength="4"></td>
                            </tr>
                            <tr>
                                <th class="w-20">フリガナ</th>
                                <td><input name="name_kana" value="{{old('name_kana', request()->query('name_kana'))}}" type="text" class="form-control" placeholder="" maxlength="64"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable dtr-inline">
                                    <tbody>
                                        <thead>
                                            <tr>
                                                <th class="sorting" rowspan="1" colspan="1" aria-label="">教習所CD</th>
                                                <th class="sorting" rowspan="1" colspan="1" aria-label="">教習所名</th>
                                                <th class="sorting" rowspan="1" colspan="1" aria-label="">フリガナ</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        @if ($models->isEmpty())
