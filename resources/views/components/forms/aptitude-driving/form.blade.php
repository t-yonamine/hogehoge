    ...
    <form class="flex flex-col w-full" method="{{ $method }}" autocomplete="off" action="{{ $route }}">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input name="student_no" type="text" class="form-control "
                                value="{{ old('student_no', $data->student_no) }}" disabled>
                        </td>
                    </tr>
                    <tr>
                        <th class="w-20">氏名</th>
                    ...
                    <tr>
                        ...
                        <td class=""><input name="test_date" type="date"
                                class="w-auto form-control @error('test_date') is-invalid @enderror"
                                value="{{ old('test_date') }}" maxlength="10">
                            @error('test_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input name="od_persty_pattern_1" type="text"
                                ...
                                value="{{ old('od_persty_pattern_1') }}" maxlength="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="od_persty_pattern_2" type="text"
                                ...
                                value="{{ old('od_persty_pattern_2') }}" maxlength="3">
                        ...
                        <td>
                            <select class="form-control w-12" name="od_drv_aptitude">
                                @foreach ($resultOneToFive as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_drv_aptitude') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-control" name="od_safe_aptitude">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_safe_aptitude') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-control" name="od_specific_rxn">
                                @foreach ($resultOneToThree as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_specific_rxn') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_a">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_a') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_b">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_b') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_c">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_c') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-control" name="od_d">
                                @foreach ($resultCharacter as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_d') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_e">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_e') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_f">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_f') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_g">
                                @foreach ($resultAToE as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_g') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-control" name="od_h">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_h') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_i">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_i') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_j">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_j') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_k">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_k') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_l">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_l') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_m">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_m') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_n">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_n') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_o">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_o') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="od_p">
                                @foreach ($resultAToC as $key => $item)
                                    <option value="{{ $item }}" @selected(old('od_p') == $item)>
                                        {{ $item }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <div class="card-footer">
            <div class="col text-right p-0 d-flex justify-content-center">
                <button class="m-1 btn btn-sm btn-secondary">
                    キャンセル
                </button>
