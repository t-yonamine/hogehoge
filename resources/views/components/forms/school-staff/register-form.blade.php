<form class="flex flex-col w-full" method="POST" id="form-search" autocomplete="off" action="{{ $route }}">
    @csrf
    @method($method)
    <input name="test_type" class="form-control" value="{{ request()->query('test_type') }}" hidden>
        ...
        <table class="table table-bordered table-view">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input name="test_type" class="form-control" value="{{ old('test_type', $data->test_type) }}" disabled>
                    </td>
                </tr>
                <tr>
    ...
    <div class="card-footer">
        <div class="col text-center">
            <a href="#" class="btn btn-sm btn-secondary">キャンセル</a>
